...
# Router for Award / Certification / ForeignLang / GlobalExp
router = DefaultRouter()
router.register(r"awards", AwardViewSet, basename="award")
router.register(r"certifications", CertificationViewSet, basename="certification")
router.register(r"foreign-langs", ForeignLangViewSet, basename="foreignlang")
router.register(r"global-exps", GlobalExpViewSet, basename="globalexp")
